        ...
        <div className="flex flex-col items-start gap-3 w-full lg:w-[40%]">
          ...
          <div className="w-full flex flex-col">
            ...
            <input 
              ...
              type="number" className="mt-3 bg-white rounded-md w-full p-2 shadow-md" placeholder="شماره تلفن" />
            <button 
              onClick={() => sendSingleSms()}
              disabled={isSingleSending}
              className="px-12 py-2 bg-cyan-600 rounded-md mt-3 w-72
               text-white text-center cursor-pointer disabled:cursor-not-allowed disabled:bg-cyan-500">
        ...
        <div className="flex flex-col items-start gap-3 w-full lg:w-[40%]">
          ...
          <div className="w-full flex flex-col">
            ...
            <textarea 
              ...
              name="phone_numbers" className="mt-3 bg-white rounded-md w-full p-2 shadow-md" placeholder="شماره ها را با Enter از یکدیگر جدا کنید" />
            <button 
